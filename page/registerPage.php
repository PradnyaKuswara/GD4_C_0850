...
<body>
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container">
            <a class="navbar-brand fw-bold" href="/GD4_C_0850">PHP - I Gusti Ngurah A Pradnya Kuswara</a>
        </div>
    </nav>
        ...
        <div class="container min-vh-100 mt-5 d-flex align-items-center justify-content-center">
            <div class="card text-white bg-dark ma-5 shadow " style="min-width: 25rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="mt-3 mb-0">Have an account? <a href="../page/loginPage.php" class="text-primary">Login
                            here!</a></p>
                </div>
            </div>
        </div>
